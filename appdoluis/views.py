...
def home(request):
  ...
  #botar aqui o tasks = Task.objects.all() na ativade anterior
  # context = { "tasks": tasks }
...
def update_task(request, task_id):
    ...
    # Converter o objeto date time para uma string para que ele pareça corretamento como valor do input do template
